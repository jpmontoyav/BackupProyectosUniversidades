...
function obj = setupSystemObjects()
        ...
        obj.readerL = vision.VideoFileReader('T1LeftSync3.mp4','ImageColorSpace','Intensity','VideoOutputDataType','uint8');
        obj.readerR = vision.VideoFileReader('T1RightSync3.mp4','ImageColorSpace','Intensity','VideoOutputDataType','uint8');
